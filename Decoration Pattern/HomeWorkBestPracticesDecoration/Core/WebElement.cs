...
namespace StabilizeCore
{
    public class WebElement
    {
        ...
        public string GetCssValue(string cssValueName) => _webElement?.GetCssValue(cssValueName);

        public void ScrollToElement()
        {
            ((IJavaScriptExecutor)_webDriver).ExecuteScript("arguments[0].scrollIntoView(false)", _webElement);
        }
